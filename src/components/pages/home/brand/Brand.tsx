...
const data = [
  { img: brand_img, text: "Audi" },
  { img: brand_img2, text: "BMW" },
  { img: brand_img3, text: "Chevrolet" },
  { img: brand_img4, text: "Chrysler" },
  { img: brand_img5, text: "Ford" },
  { img: brand_img6, text: "Honda" },
  { img: brand_img7, text: "Hyundai" },
  { img: brand_img8, text: "Infinity" },
  { img: brand_img9, text: "KIA" },
  { img: brand_img10, text: "Lexus" },
  { img: brand_img11, text: "Mazda" },
  { img: brand_img12, text: "Mercedes" },
  { img: brand_img13, text: "Mitsubishi" },
  { img: brand_img14, text: "Nissan" },
  { img: brand_img15, text: "Opel" },
  { img: brand_img16, text: "Subaru" },
  { img: brand_img17, text: "Toyota" },
  { img: brand_img18, text: "Volkswagen" },
];
  ...
  return (
    <section className="py-[30px] md:py-[50px]">
      <div className="container">
        ...
        <Description className="mt-[12px]">Выберите марку машины</Description>
